...
public extension UIView {
    public func lf_removeAllSubviews() {
        remove_all_subviews()
    }
	public func lf_enableBorder(width border_width: CGFloat = -1, color: UIColor? = nil, radius: CGFloat = -1, is_circle: Bool = false) {
		enable_border(width:border_width, color:color, radius:radius, is_circle:is_circle)
	}
	/*
	public func lf_insertGradient(color1: UIColor = .clearColor(), color2: UIColor = .clearColor(), head: CGPoint = CGPointMake(0, 0), tail: CGPoint = CGPointMake(0, 0)) {
