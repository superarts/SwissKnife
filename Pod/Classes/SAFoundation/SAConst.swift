...
public typealias SABlockBoolVoid = (() -> Bool)
public typealias SABlockVoidError = ((Error?) -> Void)
public typealias SABlockBoolError = ((Error?) -> Bool)
public typealias SABlockVoidBool = ((Bool) -> Void)
public typealias SABlockVoidPath = ((IndexPath) -> Void)
public typealias SABlockVoidString = ((String) -> Void)
